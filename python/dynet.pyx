...
cpdef Expression scaled_random_bernoulli(dim, float p, int batch_size=1): return Expression.from_cexpr(_cg.version(), c_scaled_random_bernoulli(_cg.thisptr[0], CDim(dim, batch_size), p))
