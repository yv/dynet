...
Expression random_bernoulli(ComputationGraph& g, const Dim& d, real p) { return Expression(&g, g.add_function<RandomBernoulli>({}, d, p, false)); }
Expression scaled_random_bernoulli(ComputationGraph& g, const Dim& d, real p) { return Expression(&g, g.add_function<RandomBernoulli>({}, d, p, true)); }
